...
<p align="center">
  ...
  Each coloured line represents a batch; the dashed line is the lower specification limit (LSL).
...
<p align="center">
  ...
  At this stage no modelling of the new batch is performed; its early points are only plotted against the historical trends to visually assess whether its behaviour so far is consistent with the established degradation slopes before moving to predictions.</em>
</p>
...
The tables below summarise the predictive outputs from the bootstrap simulation.  
